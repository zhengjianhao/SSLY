...
{ 
    ...
    public class BillDeliveryController : Controller
    {
        ...
        #region LoadData
        public void LoadData(ref BillDeliveryHdr Model, ref List<BillDeliveryDtl> dtls)
        {
            Model = new BillDeliveryHdr();
            Model.Active = true;
            ...
            dtls = new List<BillDeliveryDtl>();
            dtls.Add(new BillDeliveryDtl()
            {
                Code = "1500000036",
