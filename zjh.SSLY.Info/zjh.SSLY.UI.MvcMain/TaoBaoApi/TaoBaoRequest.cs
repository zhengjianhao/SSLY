...
namespace zjh.SSLY.UI.MvcMain
{
    ...
    {
        public string appkey = "21781325";
        public string appsecret = "f63fcacec1b7ad83f575bab76a2468cc ";
        ...
        /// <returns></returns>
        public List<Top.Api.Domain.Trade> LoadTradesOrders(DateTime StartCreated, DateTime EndCreated,string status)
        {
